...
if step == 1:
    ...
    with st.form("context_form"):
        ...
        win_cases = st.text_area("Win cases (optional — add any clients or outcomes you know about)", placeholder="e.g. Deployed at TalkTalk — reduced AHT by 28% in first 90 days", height=80)
